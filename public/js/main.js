...
//himanshu bisen
// Listen for 'loginSuccess' event from server
socket.on('loginSuccess', ({ username }) => {
    // Handle successful login, for example, redirect to chat page
    window.location.href = '/chat.html'; // Redirect to chat page
});

// Listen for 'loginError' event from server
socket.on('loginError', ({ message }) => {
    // Handle login error, for example, display error message to user
    alert(message);
});
